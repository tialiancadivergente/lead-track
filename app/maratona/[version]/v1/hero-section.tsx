      ...
      <div className="mx-auto mt-[78px] w-[calc(100%-32px)] max-w-[1600px] rounded-[28px] bg-[#073F43] p-4 md:mt-[88px] md:w-[90%] md:rounded-[36px] md:p-[40px]">
        <div className="flex flex-col gap-8 md:grid md:grid-cols-[minmax(0,1.65fr)_minmax(360px,0.85fr)] md:gap-[40px]">
          <div>
            ...
            <div className="flex aspect-video w-full items-center justify-center overflow-hidden rounded-[20px] bg-[#0A3034] md:rounded-[28px]">
              <div className="flex h-[74px] w-[74px] items-center justify-center rounded-full bg-[#ED2727] text-[26px] text-white shadow-lg">
                ▶
              </div>
            </div>
            ...
            <div className="relative px-2 pb-2 pt-6 text-left md:px-[92px] md:pt-7">
              ...
              <div className="relative">
                ...
                <h2 className="font-spectral text-[30px] font-bold leading-none text-white md:text-[42px]">
                  {currentLesson.title}
                </h2>
            ...
            <div className="mt-5 flex flex-col gap-3">
              {lessons.map((lesson, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-[82px] w-[118px] shrink-0 items-center justify-center overflow-hidden rounded-[12px] bg-[#0A3034]">
                      <span className="font-raleway text-[11px] font-bold uppercase text-white/40">
                        Vídeo
                      </span>
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={`font-raleway text-[9px] font-bold uppercase tracking-[0.12em] ${
                          isSelected ? "text-[#F2B534]" : "text-[#89B6B4]"
                        }`}
                      >
                      ...
                      <p className="mt-2 truncate font-raleway text-[12px] text-white">
                        {lesson.title}
                      </p>

                      <p className="mt-1 truncate font-raleway text-[11px] text-[#B9DBD8]">
                        {lesson.subtitle}
                      </p>
                    </div>
