...
export default function HeroSection({
	...
	return (
		<section
			id="hero"
			className={`relative h-[1100px] md:h-[902px] flex flex-col items-center p-4 md:p-0 justify-start overflow-hidden bg-[#071117] bg-[url('/images/oro/vv6/o_resgate_dos_otimistas_mobile.webp')] md:bg-[url('/images/oro/vv6/o_resgate_dos_otimistas_desktop.webp')] bg-cover bg-center z-0`}
		>
			<div
