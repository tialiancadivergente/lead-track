...
export default function HeroSection({
	...
	return (
		<section
			id="hero"
			className={`relative min-h-[860px] md:h-[940px] flex flex-col items-center p-4 pb-12 md:p-0 justify-start md:justify-center overflow-hidden bg-[#D3CAC0] bg-[url('/images/oro/v2/o_resgate_dos_otimistas_white_mobile.webp')] md:bg-[url('/images/oro/v2/o_resgate_dos_otimistas_white.webp')] bg-cover bg-center z-0`}
		>
			<div
				...
				<div className="w-full 2md:max-w-[528px] max-w-[440px]">
					...
					<div className="max-w-lg">
						<LeadCaptureForm
							...
							emailInputClassName="w-full border border-[#FBFBFB] flex rounded-[8px] flex-1 px-4 py-4 bg-[#FFFFFF26] text-[#07242C] placeholder:text-[#07242C]"
							ddiSelectClassName="py-4 pl-10 pr-2 bg-[#BBAFA2] rounded-l-[8px] border border-[#FBFBFB] border-r-[0px] text-[#07242C] font-medium focus:outline-none"
							phoneInputClassName="w-full px-4 py-4 rounded-r-[8px] bg-[#FFFFFF26] text-[#07242C] focus:outline-none h-[53px] border border-[#FBFBFB] border-l-[0px] placeholder:text-[#07242C]"
