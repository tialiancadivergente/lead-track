      ...
      >
        ...
        >
          ...
          <div className="w-full">
            ...
            <p className="mb-6 mx-auto text-center text-[#0D313E] text-lg sm:text-2xl sm:max-w-[600px] max-w-[400px]">
              {redLine ? (
                <span>{redLine}</span>
              ) : (
                <>
            ...
            <p className="text-center text-lg sm:text-2xl text-[#0D313E] max-w-[400px] mx-auto mb-2">
