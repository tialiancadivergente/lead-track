...
export default function ContainerTeste({
	...
	return (
		<div>
			<section
				id="hero"
				className={`relative h-[902px] flex flex-col items-center p-4 md:p-0 justify-center overflow-hidden bg-[url('/images/v21/bg.webp')] bg-cover bg-center z-0`}
			>
				<div
					...
					<div className="w-full">
						<div className="mb-8 flex justify-start">
							<Image
								...
								height={164}
								priority
								className="object-contain select-none pointer-events-none lg:w-[424px] sm:w-[280px] w-[220px]"
								style={{
									maxWidth: "100%",
									height: "auto",
								}}
						...
						>
							<div className="flex items-center justify-center leading-none gap-2 text-[#F4F0E1] font-raleway font-medium text-[14px]">
						...
						<div className="mt-6 mb-2 font-bebas-neue text-left">
							<div
								className={`text-4xl md:text-[40px] max-w-[528px] leading-none text-left text-[#f4f0e1] font-spectral font-extrabold`}
							>
								{titleRedLine}
							</div>
						</div>
						...
						<div
							className="mb-8 mt-4 max-w-[528px] text-[#D3CAC0] text-2xl font-extralight font-spectral"
						>
							{redLine ? (
								redLine
							) : (
