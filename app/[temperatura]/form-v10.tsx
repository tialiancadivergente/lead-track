...
export default function Formv10() {
  ...
  const benefitsMapping = [
    ...
    },
    {
      ...
      title: (
        <p
          className={`max-w-xl md:text-4xl uppercase font-bold mx-auto leading-7 md:-leading-10 `}
        >
          ...
          <div className="w-full max-w-2xl mx-auto mb-12">
            ...
            <div className="my-4 sm:my-8">
              {!titleRedLine ? (
                ...
                <>
                  <div
                    className={`text-2xl sm:text-4xl max-w-2xl mx-auto leading-none ${
            ...
            <div
              ...
              } mx-auto sm:text-lg text-base mb-4 font-medium`}
            >
              <span
                className={`${isDark ? "text-[#f4f0e1]" : "text-[#07242c]"}`}
              >
            ...
            >
              ...
              >
                <span className="text-[#f4f0e1] text-xs sm:text-base">
                  {isSubmitting
                    ? "PROCESSANDO..."
                    : success
                    ? "SUCESSO! AGUARDE..."
            ...
            <p
              className={`text-[#C0964B] text-sm sm:text-lg mt-4 ${
